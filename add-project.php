									...
									<div class="card-body">
										<form>
											<div class="mb-3">
												...
												<input type="text" class="form-control" placeholder="Worldnic">
											</div>
										</form>
											...
											<div class="col-xl-4">
												<div class="mb-3">
													...
													<select class="default-select w-100"
														...
														<option selected>Worldnic</option>
											...
											<div class="col-xl-4">
												<div class="mb-3">
													<label for="exampleFormControlInput2"
														class="form-label required">Url</label>
													<input type="text" class="form-control"
														id="exampleFormControlInput2"
														placeholder="worldnic.dexignlab.com">
												</div>
											</div>
											<div class="col-xl-4">
												<div class="mb-3">
													<label for="exampleFormControlInput3"
														class="form-label required">Owner</label>
													<input type="text" class="form-control"
														id="exampleFormControlInput3" placeholder="Yatin xarma">
												</div>
											</div>
											...
											<div class="col-xl-4">
												<div class="mb-3">
													<label for="exampleFormControlInput4"
														class="form-label required">Project Description</label>
													<input type="text" class="form-control"
														id="exampleFormControlInput4" placeholder="Simple AWS Project">
												</div>
											</div>
											<div class="col-xl-4">
												<div class="mb-3">
													<label for="exampleFormControlInput5"
														class="form-label required">Project State</label>
													<input type="text" class="form-control"
														id="exampleFormControlInput5" placeholder="Created">
												</div>
											</div>
										</div>
									</div>
