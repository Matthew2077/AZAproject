				...
				<div class="project-page d-flex justify-content-between align-items-center flex-wrap">
					<div class="project mb-4">
						<ul class="nav nav-tabs style-1" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" data-bs-toggle="tab" href="#AllStatus" role="tab">All
									Status</a>
							</li>
							<li class="nav-item">
										...
										<div class="row align-items-center">
											<div class="col-xl-3  col-md-4 col-sm-12 align-items-center customers">
												<div class="media-body">
													...
													<p class="mb-0"><i class="fas fa-calendar me-2"></i>Created on Sep
														8th, 2020</p>
												</div>
											</div>
											...
											<div class="col-xl-2  col-sm-6 col-sm-4 mt-xl-0  mt-3">
												<div class="d-flex justify-content-sm-end project-btn">
													<a href="javascript:void(0);"
														class="badge badge-warning light badge-sm">PENDING</a>
													<div class="dropdown c-pointer ms-4  mt-auto mb-auto">
									...
									<div class="card-body py-3 px-4">
										<div class="row align-items-center">
											...
											<div class="col-xl-2  col-sm-6 col-sm-4 mt-xl-0  mt-3">
												<div class="d-flex justify-content-sm-end project-btn">
													<a href="javascript:void(0);"
														class="badge badge-info light badge-sm">ON PROGRESS</a>
													<div class="dropdown c-pointer ms-4  mt-auto mb-auto">
														<div class="btn-link" data-bs-toggle="dropdown"
															aria-expanded="false" role="button">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
									...
									<div class="card-body py-3 px-4">
										<div class="row align-items-center">
											...
											<div class="col-xl-2  col-sm-6 col-sm-4 mt-xl-0  mt-3">
												<div class="d-flex justify-content-sm-end project-btn">
													<a href="javascript:void(0);"
														class="badge badge-danger light badge-sm">Closed</a>
													<div class="dropdown c-pointer ms-4  mt-auto mb-auto">
														<div class="btn-link" data-bs-toggle="dropdown"
															aria-expanded="false" role="button">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
