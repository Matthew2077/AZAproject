					...
					<div class="row no-gutters">
						<div class="col-xl-12">
							<div class="auth-form">
								...
								<h4 class="text-center mb-4">Password Dimenticata</h4>
								<!--AUTH FORM-->
								<form action="Authentication.php" method="POST">
									<div class="mb-3">
										<label class="form-label">Email</label>
										<input name="email" id="ic-mail" type="email" class="form-control" value="" required>
									</div>
									<div class="mb-3">
									...
									<input type="hidden" value="lostpassword" name="action"> <!--Tipologia-->
								</form>
							</div>
						</div>
					</div>
