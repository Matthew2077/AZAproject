  ...
  var dzProfile = (function () {
    var chartTasksSummary = function () {
      ...
      if ($("#chartTasksSummary").length > 0) {
        var handleTasksSummary = new ApexCharts(
          document.querySelector("#chartTasksSummary"),
          options
        );
    ...
    var chartTopSelling = function () {
      ...
      if ($("#chartTopSelling").length > 0) {
        var handleTopSelling = new ApexCharts(
          document.querySelector("#chartTopSelling"),
          options
        );
    ...
    var chartRecentStats = function () {
      var options = {
        ...
        fill: {
          opacity: 1,
          colors: ["var(--primary)", "var(--bs-gray)"],
        },
        tooltip: {
          y: {
      ...
      if (jQuery("#chartRecentStats").length > 0) {
        var chartRecentStats = new ApexCharts(
          document.querySelector("#chartRecentStats"),
          options
        );
    ...
    var chartSecuritySummary = function () {
      ...
      if (jQuery("#chartSecuritySummary").length > 0) {
        var handleSecuritySummary = new ApexCharts(
          document.querySelector("#chartSecuritySummary"),
          options
        );
    ...
    var chartTasksOverTime = function () {
      ...
      if (jQuery("#chartTasksOverTime").length > 0) {
        var handleTasksOverTime = new ApexCharts(
          document.querySelector("#chartTasksOverTime"),
          options
        );
        ...
        jQuery("#seriesComplete").on("change", function () {
          jQuery(this).toggleClass("disabled");
          handleTasksOverTime.toggleSeries("Complete");
        });
      }
    };
    ...
    var chartDeals = function () {
      ...
      if (jQuery("#chartDeals").length > 0) {
        var handleDeals = new ApexCharts(
    ...
    var chartProjectChart = function () {
      ...
      if ($("#chartProjectChart").length > 0) {
        var handleProjectChart = new ApexCharts(
          document.querySelector("#chartProjectChart"),
          options
        );
    ...
    var lineChartSecuritySummary = function () {
      ...
      if ($("#lineChartSecuritySummary").length > 0) {
        var handleLineChartSecuritySummary = new ApexCharts(
          document.querySelector("#lineChartSecuritySummary"),
          options
        );
    ...
    var chartProfileProgress = function () {
      ...
      if ($("#chartProfileProgress").length > 0) {
        var handleProfileProgress = new ApexCharts(
          document.querySelector("#chartProfileProgress"),
          options
        );
