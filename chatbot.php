						...
						<div class="card h-auto">
							<div class="card-header border-0 pb-0">
								...
								<select class="default-select custom-image-select ai-select image-select">
									<option data-thumbnail="images/svg/england.svg">England</option>
									<option data-thumbnail="images/svg/india.svg">India</option>
									<option data-thumbnail="images/svg/united-arab-emirates.svg">UAE</option>
								</select>
							</div>
								...
								<div class="row">
									<div class="col-xl-2">
										...
										<div class="btn-group d-block" role="group" aria-label="Basic radio toggle button group">
											...
											<label class="btn btn-outline-primary form-label btn-sm rounded" for="btnradio1">Yes</label>

											<input type="radio" class="btn-check" name="btnradio" id="btnradio2">
											<label class="btn btn-outline-primary form-label btn-sm rounded ms-2" for="btnradio2">No</label>
									...
									<div class="col-xl-3">
										...
										<div class="btn-group d-block" role="group" aria-label="Basic radio toggle button group">
											...
											<label class="btn btn-outline-primary form-label btn-sm rounded" for="btnradio3">Collapsed</label>

											<input type="radio" class="btn-check" name="btnradio" id="btnradio4">
											<label class="btn btn-outline-primary form-label btn-sm rounded ms-2" for="btnradio4">Expanded</label>
