								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-xl-3 col-sm-6 align-self-end">
											<div>
												<button class="btn btn-primary me-2 btn-md" title="Click here to Search"
													type="button"><i class="fa fa-filter me-1"></i>Filter</button>
												<button class="btn btn-danger light btn-md" title="Click here to remove filter"
							...
							<div class="cm-content-body form excerpt">
								<div class="card-body pb-4">
									<div class="table-responsive">
										...
										<div class="d-flex align-items-center justify-content-between justify-content-center flex-wrap">
