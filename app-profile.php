...
//$pfpname = $_SESSION ['pfp_name'] ?? 'user.jpg'; //import immagine
// echo $pfpname;
				...
				<div class="row">
										...
										<div class="profile-info">
											...
											<div class="profile-details">
												<div class="profile-name px-3 pt-2">
													<h4 class="text-white  mb-0 fs-23"><?php echo $nickname; ?></h4>
												...
												<div class="card-body">
													<div class="d-flex mb-4 align-items-start">
														<div class="dz-media me-3">
															<img src="assets/images/logo/pic1.jpg" class="img-fluid" alt="">
														</div>
														<div class="me-auto">
														...
														<span
															class="badge badge-success d-sm-inline-block d-none">Compeleted</span>
													</div>
										...
										<div class="col-xl-6 col-xxl-12">
											<div class="card project-card">
												<div class="card-body">
													<div class="d-flex mb-4 align-items-start">
														<div class="dz-media me-3">
															<img src="assets/images/logo/pic2.jpg" class="img-fluid" alt="">
														</div>
														<div class="me-auto">
															<p class="text-primary mb-1">#P-000441425</p>
															<h5 class="title font-w600 mb-2"><a href="post-details.php"
														...
														<span
															class="badge badge-info d-sm-inline-block d-none">Compeleted</span>
													</div>
													<p class="mb-4">It is a long established fact that a reader will be
														distracted by the readable content of a page when looking at its
														layout.</p>
					...
					<div class="col-xl-3 col-xxl-4">
							...
							<div class="card-body pt-3">
								...
								<div class="mt-3">
									...
									<ul class="d-flex align-items-center flex-wrap">
										...
										<li class="mb-3"><a href="" class="badge badge-light me-2">Scss</a></li>
										<li class="mb-3"><a href="" class="badge badge-light me-2">Tailwand css</a></li>
										<li class="mb-3"><a href="" class="badge badge-light">React Native</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="card h-auto">
							...
							<div class="card-body  py-3 ic-scroll height250" id="RecentActivityContent">
							...
							<div class="text-center card-footer pt-0 border-0">
								<a href="" class="btn btn-outline-primary btn-block btn-sm ic-load-more"
									id="RecentActivity" rel="assets/ajax/contacts.html">Load More</a>
							</div>
						</div>
						<div class="card h-auto">
							<div class="card-header pb-0 border-0">
							...
							<div class="card-body py-3">
								<div class="profile-interest">
									<div class="row mt-4 sp4" id="lightgallery">
										<a href="assets/images/profile/2.jpg" data-exthumbimage="assets/images/profile/2.jpg"
										...
										<a href="assets/images/profile/3.jpg" data-exthumbimage="assets/images/profile/3.jpg"
											data-src="assets/images/profile/3.jpg"
											class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="assets/images/profile/3.jpg" alt="" class="img-fluid rounded">
										</a>
										<a href="assets/images/profile/4.jpg" data-exthumbimage="assets/images/profile/4.jpg"
