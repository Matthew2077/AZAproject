...
<?php //if (isset($remainingDays) && is_numeric($remainingDays) && $remainingDays < 30): ?>
<script>
// // Passaggio del dato PHP a JavaScript
// window.onload = function() {
//     //alert("");
// 	Swal.fire("La tua password scadrà fra <?php //echo addslashes($remainingDays); ?> giorni, rinnovala al più presto!");
// };
</script>
<?php //endif; ?>
	<!--*******************
				...
				<div class="page-head">
					<div class="row">
						<div class="col-sm-6 mb-sm-4 mb-3">
							<h3 class="mb-0">Good Morning, <?php echo $nickname; ?></h3>
							...
							<div class="col-xl-5">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<h5>People Contact</h5> <!-- Barra diricerca -->
										<!-- <form action="#">
												...
												<div class="progress-box mt-0">
													...
													<div class="progress">
														<div class="progress-bar bg-primary"
															style="width:60%; height:px; border-radius:4px;"
