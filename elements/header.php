<?php
// session_start();
// $imgpath = $_SESSION ['imgpath'] ?? 'user.jpg'; //import immagine
			...
			<div class="collapse navbar-collapse justify-content-between">
				...
				<ul class="navbar-nav header-right">
					...
					<li class="nav-item dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<img src="<?php echo $imgpath; ?>" width="20" alt> <!--IMMAGINE è QUI -->
							<div class="header-info ms-3">
								<span class="fs-14 font-w600 mb-0"><?php echo $nickname; ?></span>
							</div>
							...
							<div class="card-body p-0">
								<div class="d-flex profile-media justify-content-between align-items-center">
									<div class="d-flex">
										...
										<div class="ms-3">
											<h4 class="mb-0"><?php echo $nickname; ?>	</h4>
											<p><?php echo $email; ?></p>
										</div>
									</div>
