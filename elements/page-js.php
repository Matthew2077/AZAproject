<script>
	var enableSupportButton = '<?php echo $DexignZoneSettings['site_level']['support_button'] ?>'
</script>
<script>
	var asset_url = '<?php echo !empty($DexignZoneSettings['site_level']['asset_url']) ? $DexignZoneSettings['site_level']['asset_url'] : 'assets/' ?>'
</script>
