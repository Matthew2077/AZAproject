												...
												<div class="position-relative d-flex align-items-center mb-3">
													<div>
														<a href="ecom-product-detail.php">
															<h5 class="font-w500 mb-0">Smart Watch for Worldnic</h5>
														</a>
														<span>Accessories,
															Clocks</span>
													</div>
										...
										<div class="row m-b-30">
											...
											<div class="col-xl-8 col-xxl-12">
												<div class="position-relative d-flex align-items-center mb-3">
													<div>
														<a href="ecom-product-detail.php">
															<h5 class="font-w500 mb-0">Smart Headphone for Worldnic</h5>
														</a>
														<span>Accessories,
															Clocks</span>
													</div>
										...
										<div class="row m-b-30">
											...
											<div class="col-xl-8 col-xxl-12">
												<div class="position-relative d-flex align-items-center mb-3">
													<div>
														<a href="ecom-product-detail.php">
															<h5 class="font-w500 mb-0">Smart Charger for Worldnic</h5>
														</a>
														<span>Accessories,
															Clocks</span>
													</div>
										...
										<div class="row m-b-30">
											...
											<div class="col-xl-8 col-xxl-12">
												<div class="position-relative d-flex align-items-center mb-3">
													<div>
														<a href="ecom-product-detail.php">
															<h5 class="font-w500 mb-0">Smart Wallet for Worldnic</h5>
														</a>
														<span>Accessories,
															Clocks</span>
													</div>
										...
										<div class="row m-b-30">
											...
											<div class=" col-xl-8 col-xxl-12">
												<div class="position-relative d-flex align-items-center mb-3">
													<div>
														<a href="ecom-product-detail.php">
															<h5 class="font-w500 mb-0">Smart Earbuds for Worldnic</h5>
														</a>
														<span>Accessories,
															Clocks</span>
													</div>
