					...
					<div class="col-xl-3">
						<div class="row">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="progress-box mt-0">
											<p>Usage of 250GB</p>
											<div class="progress">
												<div class="progress-bar bg-primary" style="width:50%; height:5px;" role="progressbar"></div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<h4 class="card-title">Details Storage</h4>
									</div>
									...
									<div class="card-body">
										...
										<div class="progress-box mt-0">
											<p>Usage of 250GB</p>
											<div class="progress">
												<div class="progress-bar bg-success" style="width:50%; height:5px;" role="progressbar"></div>
											</div>
										</div>
										<hr>
										<div class="depostit-card-media d-flex justify-content-between ">
										...
										<div class="progress-box mt-0">
											<p>Usage of 250GB</p>
											<div class="progress">
												<div class="progress-bar bg-secondary" style="width:50%; height:5px;" role="progressbar"></div>
											</div>
										</div>
									</div>
								</div>
