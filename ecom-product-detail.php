															...
															<div class="month-deal">
																<div>
																	...
																	<p class="mb-0">Yes! Send me exclusive offers,
																		...
																		shopping on Worldnic <a
																			href="shop-standard.php"
																...
																<div class="card-body product-card border ">
																	<div class="dz-product-bx">
																		...
																		<img loading="lazy" class="dz-media-1"
																			src="assets/images/product/pic1.jpg" alt="">
																	...
																	<div class="new-arrival-content text-center mt-3">
																		<h4><a href="ecom-product-detail.php">Bonorum
																				et Malorum</a></h4>
															...
															<div class="card">
																<div class="card-body product-card border ">
																	<div class="dz-product-bx">
																		...
																		<img loading="lazy" class="dz-media-1"
																			src="assets/images/product/pic2.jpg" alt="">
																		<div class="dz-side-view">
																			<a href="javascript:void(0)"
																				class="wishlist mb-2">
																				<i class="fa-regular fa-heart"></i>
															...
															<div class="card">
																<div class="card-body product-card border ">
																	<div class="dz-product-bx">
																		...
																		<img loading="lazy" class="dz-media-1"
																			src="assets/images/product/pic3.jpg" alt="">
																		<div class="dz-side-view">
																			<a href="javascript:void(0)"
																				class="wishlist mb-2">
																				<i class="fa-regular fa-heart"></i>
															...
															<div class="card">
																<div class="card-body product-card border ">
																	<div class="dz-product-bx">
																		...
																		<img loading="lazy" class="dz-media-1"
																			src="assets/images/product/pic4.jpg" alt="">
																		<div class="dz-side-view">
																			<a href="javascript:void(0)"
																				class="wishlist mb-2">
																				<i class="fa-regular fa-heart"></i>
													...
													<div class="row">
														<div class="col-xl-6">
															<div class="d-flex align-items-strat">
																<img src="assets/images/users/pic1.jpg" class="product-img"
																	alt="">
																<div>
