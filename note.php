								...
								<div class="row g-0">
									<div class="col-xl-2 col-xxl-3">
										<div class="mail-left-body dz-resp-tab">
											<div class=" ps-4 pe-3 py-4 ic-scroll height800">
										...
										<div class="p-4">
											<div class="row">
												...
												<div class="col-xl-4">
													...
													<div class="card ic-send-bx bgl-success">
												...
												<div class="col-xl-4">
													<div class="card ic-send-bx bgl-warning">
														<div class="card-header align-items-strat border-0 pb-0">
												...
												<div class="col-xl-4">
													<div class="card ic-send-bx bgl-danger">
														<div class="card-header align-items-strat border-0 pb-0">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-xl-12">
								...
								<div class="mb-3">
									<label class="form-label required d-block">Tag</label>
									<select class="default-select status-select w-100">
