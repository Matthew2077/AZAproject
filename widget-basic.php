				...
				<div class="row">
					<div class="col-xl-4 col-xxl-6 col-lg-6">
						<div class="card">
							...
							<div class="card-body p-0">
								<div id="DZ_W_TimeLine" class="widget-timeline ic-scroll p-4 height370">
									<ul class="timeline">
										<li>
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
						<div class="card">
							...
							<div class="card-body p-0">
								<div id="DZ_W_TimeLine11" class="widget-timeline ic-scroll p-4 style-1 height370">
									<ul class="timeline">
										<li>
											<div class="timeline-badge primary"></div>
											<a class="timeline-panel text-muted" href="#">
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
						<div class="card">
							...
							<div class="card-body p-0">
								<div id="DZ_W_Todo1" class="widget-media ic-scroll p-4 height370">
									<ul class="timeline">
										<li>
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
						<div class="card border-0 pb-0">
							...
							<div class="card-body p-0">
								<div id="DZ_W_Todo2" class="widget-media ic-scroll p-4 height370">
									<ul class="timeline">
										<li>
											<div class="timeline-panel">
												<div class="media me-2">
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
						<div class="card border-0 pb-0">
							...
							<div class="card-body p-0">
								<div id="DZ_W_Todo3" class="widget-media p-4 ic-scroll height370">
									<ul class="timeline">
										<li>
											<div class="timeline-panel">
												<div class="media me-2">
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
						<div class="card border-0 pb-0">
							...
							<div class="card-body p-0">
								<div id="DZ_W_Todo4" class="widget-media ic-scroll p-4 height370">
									<ul class="timeline">
										<li>
											<div class="timeline-panel">
							...
							<div class="card-body">
								<div class="text-center">
									<div class="profile-photo">
										<img src="assets/images/profile/profile.png" width="100"
													...
													<div class="dropdown custom-dropdown mb-0">
														...
														<div class="dropdown-menu dropdown-menu-end">
															<a class="dropdown-item"
																href="javascript:void();;">Details</a>
						...
						<div class="card text-white bg-primary">
							<ul class="list-group list-group-flush">
								<li class="list-group-item d-flex justify-content-between"><span
										class="mb-0 text-white">Blood type :</span><strong
										class="text-white">O+</strong></li>
								<li class="list-group-item d-flex justify-content-between"><span
										class="mb-0 text-white">Allergies :</span><strong class="text-white">Penicilin,
										peanuts </strong></li>
								<li class="list-group-item d-flex justify-content-between"><span
										class="mb-0 text-white">Pressure :</span><strong class="text-white">120/100
										mmHG</strong></li>
								<li class="list-group-item d-flex justify-content-between"><span
										class="mb-0 text-white">Diseases :</span><strong
										class="text-white">Diabetes</strong></li>
								<li class="list-group-item d-flex justify-content-between"><span
										class="mb-0 text-white">Temperture :</span><strong class="text-white">34
										Degree</strong></li>
							</ul>
						</div>
					</div>
					...
					<div class="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
						<div class="card">
							<div class="card-body text-center ai-icon  text-primary">
								...
								<a href="javascript:void();;" class="btn my-2 btn-primary px-4"><i
